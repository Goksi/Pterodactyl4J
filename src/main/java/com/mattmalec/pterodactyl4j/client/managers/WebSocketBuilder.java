...
public class WebSocketBuilder {
    ...
    public WebSocketBuilder(PteroClientImpl api, ClientServer server) {
        this.api = api;
        this.server = server;
        this.eventManager = api.getP4J().getEventManager();
    }
     ...
     * @throws java.lang.IllegalArgumentException If one of the listeners does not implement {@link com.mattmalec.pterodactyl4j.client.ws.hooks.ClientSocketListener ClientSocketListener}
     ...
     *
     * @param enable True - provide a fresh instance of the {@link com.mattmalec.pterodactyl4j.client.entities.ClientServer ClientServer}
     *               in event context
