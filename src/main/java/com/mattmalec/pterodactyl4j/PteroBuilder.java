...
public class PteroBuilder {
    ...
    private IClientListenerManager eventManager = null;
     ...
     *
     * @param applicationUrl The URL of the Pterodactyl panel
    ...
    public PteroBuilder setEventManager(IClientListenerManager eventManager) {
    ...
    private P4J build() {
        ...
        SessionConfig sessionConfig = new SessionConfig(httpClient, webSocketClient, eventManager);
     ...
     * @throws IllegalArgumentException If the provided URL or token is empty or null.
